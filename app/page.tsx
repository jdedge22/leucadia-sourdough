    ...
    <div>
      ...
      <section className="relative h-96 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          <Link
            href="/subscribe"
            className="hover:opacity-90 text-white px-8 py-4 rounded-lg text-lg font-semibold transition shadow-xl inline-block"
      ...
      {/* Our Breads */}
      <section id="breads" className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold mb-12 text-center text-gray-900">Our Breads</h2>

          <div className="grid md:grid-cols-3 gap-8">
            {breads.map(bread => (
              <div key={bread.id} className="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col border border-gray-200">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3 className="text-2xl font-bold mb-3 text-gray-900">{bread.name}</h3>
                  <p className="text-gray-700 mb-4 flex-grow">{bread.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-gradient-to-b from-orange-50 to-amber-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-gray-700">Subscribe for weekly delivery — plans start at $38 every 4 weeks</p>
          <Link
            href="/subscribe"
