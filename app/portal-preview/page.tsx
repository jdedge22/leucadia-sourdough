      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
          <div className="flex justify-between items-center">
            ...
            <button className="px-4 py-2 text-gray-600 hover:text-gray-900 border border-gray-300 rounded-lg">
              Sign Out
            </button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <a href="mailto:hello@leucadiasourdough.com" className="text-blue-600 hover:text-blue-800 font-semibold">
              Send Email
            </a>
          </div>
        </div>
